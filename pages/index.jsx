            ...
            <section className="section m-b-70">
              ...
              <div className="block block-sliders auto-height color-white nav-center">
                ...
                >
                  ...
                  {/*                    href="javascript:void(0)">Explore Bestseller</a>*/}
                  {/*            </div>*/}
                  {/*        </div>*/}
                  {/*    </div>*/}
                  {/*</div>*/}
                              ...
                              <div className="banner-wrapper-infor">
                                <div className="info">
                                  <div className="content">
                                    ...
                                    {/*<a class="button" href="javascript:void(0)">Shop Now</a>*/}
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    <div className="block-content ">
                      <div className="product-cats-list slick-wrap ">
                        ...
                        >
                          ...
                          {/*                    src="media/product/cat-1.jpg" alt="Bracelets">*/}
                          {/*            </div>*/}
                          {/*        </a>*/}
                          ...
                          {/*</div>*/}
                          {/*?php
                                                      // $res = mysqli_query($con,"select sct.sub_cat_name, cn.category_name, cn.category_id from sub_category_tbl sct INNER JOIN category_tbl cn on sct.category_id = cn.category_id where sct.sub_cat_id = '$subId' ");
                                                      // $list = mysqli_fetch_assoc($res);

                                                      $sql=mysqli_query($con,"SELECT sct.sub_cat_name, sct.sub_cat_id, dt.design_image, ct.category_name,ct.category_id, COUNT(dt.design_id) Count FROM sub_category_tbl sct 
                                                      INNER JOIN design_tbl dt on sct.sub_cat_id = dt.design_sub_cat 
                                                      INNER JOIN category_tbl ct on sct.category_id = ct.category_id 
                                                      group by sct.sub_cat_id order by rand() limit 8");
                                                          while($row= mysqli_fetch_assoc($sql)){
                                                  ?*/}
                          <div className="item item-product-cat slick-slide ">
                            <div className="item-product-cat-content ">
                              <a
                                href="product?sId=<?php echo encrypt($row['sub_cat_id']) ?>"
                                data-set="<?php echo $row['sub_cat_id'] ?>"
                              >
                              ...
                              <div className="product-cat-content-info">
                                <h2 className="item-title">
                                  <a href="product?sId=<?php echo encrypt($row['sub_cat_id']) ?>">
                                    {/*?php echo strtoupper($row['sub_cat_name']) ?*/}{" "}
                                    {" "}
                    ...
                    <div className="block-content">
                      <div className="content-product-list slick-wrap">
                        ...
                        >
                          ...
                          {/*                <div class="contents">*/}
                          {/*                    <div class="rating">*/}
                          {/*                        <div class="star star-5"></div><span*/}
                          {/*                            class="count">(1 review)</span>*/}
                          {/*                    </div>*/}
                          {/*                    <h3 class="product-title"><a*/}
                          {/*                            href="shop-details.html">Bold Pearl Hoop*/}
                          {/*                            Earrings</a></h3>*/}
                          {/*                    <span class="price">*/}
                          {/*                        <del*/}
                          ...
                          {/*?php
                                                  ...
                                                  design_tbl  where design_sta='1' && design_sub_cat IS NOT NULL order by rand() limit 8");
                                                  while($row= mysqli_fetch_assoc($sql)){
                                                  ?*/}
                          <div className="item-product slick-slide">
                            <div className="items">
                              <div className="products-entry clearfix product-wapper">
                                <div className="products-thumb img-water">
